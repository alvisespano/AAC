...
public class SupplierParser extends ParserWithProgressBar<SupplierParser.Data, PercentProgressStepper, SupplierParser.Actual> implements Serializable {

    public SupplierParser(@NonNull Pool<ProgressBar> pb) {
        super(new Actual(), pb);
    }

    public static class Actual extends AbstractAsyncParser<SupplierParser.Data, PercentProgressStepper> {
