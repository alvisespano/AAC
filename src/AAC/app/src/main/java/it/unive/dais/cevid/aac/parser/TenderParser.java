...
public class TenderParser extends ParserWithProgressBar<TenderParser.Data, PercentProgressStepper, TenderParser.Actual> {

    public TenderParser(String lotto, @NonNull Pool<ProgressBar> pb) {
        super(new Actual(lotto), pb);
    }

    public static class Actual extends AbstractAsyncParser<TenderParser.Data, PercentProgressStepper> {
