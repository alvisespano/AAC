package it.unive.dais.cevid.aac.abstarctItemSearch.comparison.activities;
...
import it.unive.dais.cevid.aac.abstarctItemSearch.comparison.fragment.FragmentAdapter;
import it.unive.dais.cevid.aac.R;
import it.unive.dais.cevid.aac.item.AbstractItem;
import it.unive.dais.cevid.datadroid.lib.parser.AppaltiParser;
import it.unive.dais.cevid.datadroid.lib.parser.SoldipubbliciParser;

public class AIComparisonResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mode == Mode.APPALTI || mode == Mode.SOLDI_PUBBLICI || mode == Mode.COMBINE) {
            setContentView(R.layout.activity_ai_comparison_result);
        } else {
